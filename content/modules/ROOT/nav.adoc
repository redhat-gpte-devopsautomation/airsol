...
** xref:04-02-car-recog.adoc[4.2 Baggage recognition (Optional)]
** xref:04-03-model-retraining.adoc[4.3 Model retraining (Optional)]
** xref:04-04-accident-recog.adoc[4.4 Baggage Damage recognition (Optional)]
...
** xref:05-05-process-claims.adoc[5.5 Process Baggage claims with a pipeline]
