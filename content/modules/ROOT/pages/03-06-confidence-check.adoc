...
In the `sentiments/lab-materials/03/06` folder there are two pipeline files, one `confidence_check.pipeline` and one `confidence_check.yaml` file.
...
. Navigate to the folder `sentiments/lab-materials/03/06`
