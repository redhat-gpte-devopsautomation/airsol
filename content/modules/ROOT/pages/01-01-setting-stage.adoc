...
In order to make this "{company-name}" related "{ic-lab}" seem more realistic, we will be describing this imaginary scenario.

== Situation
:slide:

* We all work for a large Aviation company called "{company-name}":
...
** Review the way baggage claims are currently being processed and also understand customer sentiments
